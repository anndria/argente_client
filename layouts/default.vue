                        ...
                        <Menu as="div" class="relative">
                            <MenuButton class="-m-1.5 flex items-center p-1.5">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">Bals Apologist</span>
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="about" name="about" rows="3"
                                    class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm outline-0 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
...
const navigation = [
    ...
    { name: 'Contact', href: '/contact', icon: ChatBubbleLeftIcon, current: false },
    { name: 'FAQs', href: '/faqs', icon: MagnifyingGlassIcon, current: false },
]
const teams = [
